  ...
  private getWorkHoursForShift(shiftType: string) {
    ...
    switch (shiftType) {
      case 'EXTENDED_9_5H':
        return [
          ...baseHours,
          { hour: 9, startTime: '16:30', endTime: '18:00' } // ⭐ FIXED: 1.5 hours
        ];
      case 'OVERTIME_11H':
        return [
          ...baseHours,
          { hour: 9, startTime: '17:00', endTime: '18:00' },  // ⭐ FIXED
          { hour: 10, startTime: '18:00', endTime: '19:00' }, // ⭐ FIXED
          { hour: 11, startTime: '19:00', endTime: '20:00' }  // ⭐ FIXED
        ];
      default:
        return baseHours;
    }
